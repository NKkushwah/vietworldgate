  ...
  return (
    <>
      ...
      <div className="top-header">
        ...
        {/* SEARCH BOX — shifted left with margin-right */}
        <SearchBox />
        ...
        <div className="header-right">
            ...
            {notifOpen && (
              <div className="notif-panel">
                ...
                <div className="notif-tabs">
                  ...
                  <span className="ntab">Unread (1)</span>
                </div>

                <div className="notif-item unread">
                  <div className="notif-icon-circle">🔔</div>
                  <div className="notif-text">
                    <p className="notif-title">You have 1 new notification</p>
                    <p className="notif-desc">
                      Your consultation request has been received. Our advisor will contact you shortly.
                    </p>
                ...
                <div className="notif-empty">No older notifications</div>
          ...
          {/* PROFILE BUTTON */}
          {
            profile == null ? (<Link to="/Authpage" className="login-link">
  Login
</Link> )
            : (
              <> 
            ...
            >
              <div className="avatar-circle">RK</div>
            ...
            {profileOpen && (
              <div className="profile-dropdown">
                ...
                <ul className="profile-menu">
                  <li><Link to="/StudentDashboard" onClick={() => setProfileOpen(false)}>Dashboard</Link></li>
                  ...
                  <li className="logout"><Link onClick={handleLogout}>Logout</Link></li>
                </ul>
