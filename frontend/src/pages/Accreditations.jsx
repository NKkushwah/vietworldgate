...
const ADVANTAGES = [
  {
    ...
    desc: "Our certified consultants have deep knowledge of visa rules, documentation, and procedures for every destination we cover.",
  },
  {
    icon: "🌐", bg: "#E4F0FF",
    title: "Multi-Country Coverage",
    desc: "From the UK to Australia, Canada to Singapore — one team, one platform, every destination handled with precision.",
  },
  {
    icon: "📊", bg: "#E8F5E9",
    title: "Highest Success Rate",
    desc: "A 98% visa approval record built over 9 years of practice, strong embassy relationships, and meticulous case preparation.",
  },
  {
    icon: "🔒", bg: "#F3E5F5",
    title: "Full Transparency",
    desc: "Real-time application tracking, honest timelines, and zero hidden fees. You always know exactly where your case stands.",
  },
];
...
───────────────────────────────────────── */
    ...
    <section className="worldmap" id="countries" ref={mapRef}>
      ...
      <div className="worldmap__container">
        <div className="worldmap__map-wrap">
          {/* Detailed High-Fidelity World Map Layout */}
          ...
          {DESTINATIONS.map((d) => {
            ...
            return (
              <div key={d.id} className={`worldmap__marker-node ${isActive ? "worldmap__marker-node--active" : ""}`} style={d.style}>
                ...
                {/* Elegant Dropdown Box Concept for Desktop */}
                {isActive && (
 ...
 className="worldmap__tooltip-action">Apply Now &rarr;</a>
        ...
        {/* Premium Mobile App-Style Sheet Drawer */}
        {activeData && (
          <div className="worldmap__mobile-drawer">
            <div className="worldmap__drawer-backdrop" onClick={() => setActive(null)}></div>
...
/* ─────────────────────────────────────────
   PAGE (default export — use this in App.jsx)
───────────────────────────────────────── */
