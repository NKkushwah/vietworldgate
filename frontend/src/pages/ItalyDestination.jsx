      ...
      <div className="ita-page-wrapper">
        ...
        <div className="ita-main-grid">
          ...
          <aside className="ita-sidebar">
            ...
            <div className="ita-wa-card">
              <div className="ita-wa-header">
                <div className="ita-wa-icon">
          ...
          <main className="ita-content-panel">
            ...
            <section className="ita-copy-block">
            ...
            <section className="ita-features-grid">

              <div className="ita-feature-card">
            ...
            {/* SECTION 4: CTA Block */}
            <section className="ita-cta-block">
              ...
              <div className="ita-btn-row">
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="ita-primary-btn">
        ...
        <a href={whatsappLink} className="ita-wa-bubble" target="_blank" rel="noopener noreferrer">
          <span>💬</span>
        </a>
