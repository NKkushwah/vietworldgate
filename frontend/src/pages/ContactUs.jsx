...
import { MapPin, Phone, MessageSquare, Mail, RotateCw } from "lucide-react";
...
export default function ContactUs() {
  ...
  const phoneNumbers = [
    { label: "Domestic (India):", number: "+91-7982295530" },
    { label: "International:", number: "+44 7500494401" }
  ];
  ...
  <p className="card-text" style={{ wordBreak: 'break-all', marginTop: '4px' }}>
